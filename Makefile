...
export TERRAFORM_PROVIDER_VERSION := 1.36.2
export TERRAFORM_PROVIDER_DOWNLOAD_NAME := https://github.com/hetznercloud/terraform-provider-hcloud/releases/download/v1.36.2
export TERRAFORM_NATIVE_PROVIDER_BINARY := https://releases.hashicorp.com/terraform-provider-hcloud/1.36.2/
